...
class BertFlashAttention(nn.Cell):
    """
    ...
    def __init__(self,
        ...
        super(BertFlashAttention, self).__init__()
        self.num_attention_heads = num_attention_heads
        ...
        self.flash_attention = FlashAttentionScore(head_num=num_attention_heads,
                                                   input_layout="BNSD",
                                                   sparse_mode=0, # lxy
                                                   scale_value=1 / math.sqrt(size_per_head))
    ...
    def construct(self, from_tensor, to_tensor, attention_mask):
        ...
        shape_from = F.shape(attention_mask)[2] # seq length
        ...
        _, _, _, context_layer = self.flash_attention(query_layer.astype(mstype.float16),
                                                      key_layer.astype(mstype.float16),
                                                      value_layer.astype(mstype.float16),
                                                      None, None, None, attention_mask, None)
...
class BertSelfAttention(nn.Cell):
    ...
    def __init__(self,
        ...
        self.attention = BertFlashAttention(
