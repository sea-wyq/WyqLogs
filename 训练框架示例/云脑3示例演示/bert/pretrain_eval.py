...
from src.dataset import create_eval_dataset, CreateEvalDatasetInput
...
def bert_predict():
    ...
    inputs = CreateEvalDatasetInput(batchsize=cfg.batch_size, device_num=1, data_dir=cfg.eval_data_dir)
    dataset = create_eval_dataset(inputs)
